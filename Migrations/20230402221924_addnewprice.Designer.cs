...
namespace newproject.Migrations
{
    ...
    [Migration("20230402221924_addnewprice")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TP1.Models.TablePlancher", b =>
                {
                    ...
                    b.Property<double>("cout_matier_new")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("newproject.Models.LoginViewModel", b =>
                {
                    ...
                    b.Property<int>("superviseurid_superviseur")
                        .HasColumnType("int");

                    b.HasKey("Username");

                    b.HasIndex("superviseurid_superviseur");
            ...
            modelBuilder.Entity("newproject.Models.LoginViewModel", b =>
                {
                    b.HasOne("TP1.Models.Superviseur", "superviseur")
                        .WithMany()
                        .HasForeignKey("superviseurid_superviseur")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
